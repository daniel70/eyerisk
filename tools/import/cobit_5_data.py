...
# changed the implementation from accessing the Google Drive from script to reading a simple CSV file
# this requires you to export the Google Sheet to a CSV file first and then point to it in this script
DATABASE_URL = os.environ['DATABASE_URL']
csv_file = "cobit 5 data - RACI.csv"
